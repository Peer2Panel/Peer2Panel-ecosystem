async function main () {
    ...
    Book_value = calculate_SolarT_Book_Value(monthly_payment, remaining_payments, book_IRR);
...
function calculate_SolarT_Book_Value(monthly_payment, remaining_payments, annual_IRR) {  //IRR in %/year
